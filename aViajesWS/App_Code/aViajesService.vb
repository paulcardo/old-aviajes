...
Public Class aViajesService
	...
	<WebMethod()> Public Function UpdateFacturaDetalleImpreso(ByVal FacNumId As Integer) As System.Xml.XmlDocument
        Dim xmlDoc As New XmlDocument
        xmlDoc = SqlHelper.GetXmlDocFromSP(conn, "root", "mngsp_UpdateFacturaDetalleImpreso", FacNumId)
        Return xmlDoc
    End Function
End Class