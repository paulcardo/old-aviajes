package com.adobe.cairngorm.project.event 
{
	 ...
	 */
	public class ExpedienteCostoDetalleDeleteEvent extends CairngormEvent 
	{
		/**
		 ...
		 * The constructor
		 */
		public function ExpedienteCostoDetalleDeleteEvent( expedienteCostoDetalleVO : ExpedienteCostoDetalleVO ) 
		{
			super( MainControl.EVENT_EXPEDIENTECOSTODETALLEDELETE );
