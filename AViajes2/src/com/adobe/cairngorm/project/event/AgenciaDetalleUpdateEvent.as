package com.adobe.cairngorm.project.event 
{
	 ...
	 */
	public class AgenciaDetalleUpdateEvent extends CairngormEvent 
	{
		/**
		 ...
		 * The constructor
		 */
		public function AgenciaDetalleUpdateEvent( agenciaDetalleVO : AgenciaDetalleVO ) 
		{
			super( MainControl.EVENT_AGENCIADETALLEUPDATE );
