...
#Region "private utility methods & constructors"
    ...
    Private Shared Sub PrepareCommand(ByVal command As SqlCommand, _
        ...
        command.CommandTimeout = 600 'tks jul.27.2009 This is to run flex admin reports
...
#End Region
    ...
    Public Overloads Shared Function GetXmlDocFromSP(ByVal conn As SqlConnection, ByVal NodeName As String, ByVal spName As String, ByVal ParamArray parameterValues() As Object) As XmlDocument
        Dim retVal As XmlDocument

        Dim xmlRdr As XmlReader

        xmlRdr = SqlHelper.ExecuteXmlReader(conn, spName, parameterValues)

        retVal = New System.Xml.XmlDocument()

        retVal.LoadXml("<" + NodeName + "></" + NodeName + ">")


        While (xmlRdr.ReadState <> System.Xml.ReadState.EndOfFile)

            Try
                retVal.DocumentElement.AppendChild(retVal.ReadNode(xmlRdr))
