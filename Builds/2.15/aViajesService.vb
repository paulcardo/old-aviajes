...
Public Class aViajesService
    ...
    <WebMethod()> Public Function UpdateFacturaDetalle(ByVal FacNumId As Integer, ByVal FacId As Integer, ByVal ExpAnno As Integer, ByVal ExpNum As Integer, ByVal fecha As String, ByVal estId As String, ByVal total As String, ByVal tipoCambio As String, ByVal agNombre As String, ByVal agntNombre As String, ByVal paxNombre As String, ByVal usrNombre As String, ByVal detalle As String) As System.Xml.XmlDocument
        Dim xmlDoc As New XmlDocument
        xmlDoc = SqlHelper.GetXmlDocFromSP(conn, "root", "mngsp_UpdateFacturaDetalle", FacNumId, FacId, ExpAnno, ExpNum, fecha, estId, total, tipoCambio, agNombre, agntNombre, paxNombre, usrNombre, detalle)
        Return xmlDoc
    End Function
